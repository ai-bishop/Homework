## Problem 6.1: simple bar
# based upon main_simpleBar.jl
...
quad_rules = Dict("line" => Quadrature.gauss_legendre_1d(2))        # change to "quad" and n=3?
...
IEN = Dict("line" => zeros(Int, nel, nee))          # change type to quad?
# let's use the same ordering from class            # also change all to quad?
IEN["line"][1,:] = [1, 3]
IEN["line"][2,:] = [3, 4]
IEN["line"][3,:] = [4, 5]
IEN["line"][4,:] = [5, 2]
